...
(function( $, undefined ) {
	...
	var mainController;
	mwp.on( 'wprx-todolist.ready', function(c){ mainController = c; } );
	 ...
	 * Example:
	 *
	 * <div data-view-model="wprx-todolist">
	 *   <span data-bind="text: title"></span>
	 * </div>
	 */
	mwp.controller.model( 'wprx-todolist', 
	{
		...
		init: function()
		{
			...
			this.viewModel = {
				title: ko.observable( 'To Do List' )
			};
		}
